...
<p />
<h2>Pages</h2>
<!-- web-app/webapp/views/admin/siteconfig.php:<?=__LINE__?> 1727000494 -->
<div id="site_pages" class="tableform">
    <div><span>Position</span><span>Name</span></div>
    <?php foreach ($sc->pages as $pos => $page): ?>
        <form id="pi-<?=$page->PageId?>" action="<?=$scriptURL . '/siteconfig'?>" onsubmit="return false;" draggable="true">
            <input type="hidden" name="pageid" value="<?=$page->PageId?>">
            <span class="center"><?=$pos?></span>
...
<script src="<?=$baseURL?>js/reorder.js"></script>
